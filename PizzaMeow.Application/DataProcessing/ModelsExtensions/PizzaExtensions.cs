...
public static class PizzaExtensions
{
    ...
    {
        return sort.PizzaSortDirection == PizzaSortDirection.Descending ? pizzas.OrderByDescending(GetKeySelector(sort.OrderBy)) : pizzas.OrderBy(GetKeySelector(sort.OrderBy));
    }
